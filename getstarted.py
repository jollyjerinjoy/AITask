...
options.set_capability("platformName", "Android")   # Update as per your device
options.set_capability("platformVersion", "15")  # Update as per your device
options.set_capability("deviceName", "RZCW50TA3QK")  #  # Update as per your device
options.set_capability("appPackage", "com.symantec.securewifi")   # Update as per your test app
#options.set_capability("appActivity", "com.symantec.securewifi.ui.main.MainActivity")
options.set_capability("appActivity", "com.symantec.securewifi.ui.MainActivity")   # Update as per your test app
